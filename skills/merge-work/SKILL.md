...
**Announce at start:** "I'm using the SKILL:merge-work skill to complete this work."
...
If the base branch is ambiguous, confirm through `SKILL:ask-user`:
- header: `Base Branch`
...
**Normal repo / named-branch worktree — use `SKILL:ask-user`:**
...
**Detached HEAD — use `SKILL:ask-user`:**
- header: `Complete Work`
...
**Confirm through `SKILL:ask-user`:**
...
If no user is available, do NOT discard — keep the branch as-is. (Destructive actions never auto-approve; see `SKILL:ask-user`.)
