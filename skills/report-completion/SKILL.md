...
8. **Commit and transition** — commit report + markers, invoke SKILL:merge-work
...
**Preceded by:** SKILL:verify-work (feature must be verified before documenting)
**Followed by:** SKILL:merge-work (the terminal workflow step)

After saving the report and marking specs, offer transition:

> "Final report written and committed to `<path>`. Related specs marked. Ready to finish the branch — invoking SKILL:merge-work."
